 ...
 */
package com.sampah_ku.sampahku.augmented_reality.common;
...
*            float representing the bottom row left value.
     * @param c3
     */
    public void set(double a1, float a2, double a3, float b1, double b2, double b3, double c1, double c2, double c3) {
        this.a1 = (float) a1;
        this.a2 = a2;
        this.a3 = (float) a3;
