...
import com.sampah_ku.sampahku.augmented_reality.common.Matrix;
import com.sampah_ku.sampahku.augmented_reality.common.Navigation;
import com.sampah_ku.sampahku.augmented_reality.common.Orientation;
...
public class SensorsActivity extends Activity implements SensorEventListener, LocationListener {
    ...
    public void onStart() {
        ...
        // [ 0,    1,   0   ]
        // [ -sin, 0,   cos ]
        yAxisRotation.set(Math.cos(neg90rads),  0f, Math.sin(neg90rads),
                          0f,                        1f, 0f,
                          -Math.sin(neg90rads), 0f, Math.cos(neg90rads));
        ...
        try {
            ...
            try {
                ...
                synchronized (mageticNorthCompensation) {
                    ...
                    // [ 0, 1, 0 ]
                    // [ -sin, 0, cos ]
                    mageticNorthCompensation.set(Math.cos(dec),     0f, Math.sin(dec),
                                                 0f,                     1f, 0f, 
                                                 -Math.sin(dec), 0f, Math.cos(dec));
                }
            } catch (Exception ex) {
                ex.printStackTrace();
            }
